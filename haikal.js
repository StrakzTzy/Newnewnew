...
if (!text) return reply(`Penggunaan Salah Harusnya ${prefix+command} Mas Kizyy`)
...
"inviteExpiration": `MY NAME KIZYY KANAERU${buttonkal}`,
"groupName": `MY NAME KIZYY KANAERU${buttonkal}`,
"caption": `${buttonkal}`,
